...
const mockProviderData = [
  { name: 'Claude Opus 4.5', value: 450 },
  { name: 'Claude Sonnet 4.5', value: 320 },
  { name: 'Claude Haiku 3.5', value: 180 },
  { name: 'Scaleway AI', value: 120 },
]
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Detailed insights into your API usage and consumption
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Requests by AI provider and model
            </CardDescription>
          </CardHeader>
          <CardContent>
