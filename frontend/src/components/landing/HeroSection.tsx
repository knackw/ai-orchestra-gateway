...
import { ArrowRight, Play, Shield, Server, Zap, Sparkles } from 'lucide-react'
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute right-1/4 top-1/3 h-96 w-96 animate-pulse rounded-full bg-secondary/5 blur-3xl" style={{ animationDelay: '1s' }} />
      </div>
        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center py-20 text-center md:py-32">
          ...
          >
            ...
            <div className="mb-8 inline-flex items-center rounded-full border bg-background/50 px-4 py-1.5 text-sm backdrop-blur-sm">
              ...
              v2.0 jetzt verfügbar - Enterprise Ready
            </div>
            ...
            <p className="mb-10 max-w-2xl text-lg text-muted-foreground md:text-xl">
              Multi-Provider AI Gateway mit Privacy Shield.
              <br className="hidden sm:inline" />
              Sichere AI-Integration für europäische Unternehmen.
            </p>
            ...
            <div className="mt-16 flex flex-wrap items-center justify-center gap-8">
              {trustBadges.map((badge, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 transition-transform hover:scale-110">
